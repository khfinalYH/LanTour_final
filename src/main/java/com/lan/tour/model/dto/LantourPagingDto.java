...
public class LantourPagingDto {
	...
	public void setTotPage(int totPage) {
		this.totPage = (int) Math.ceil(totPage/ (double)PAGE_SCALE);
	}
	...
	public void setTotBlock(int totBlock) {
		this.totBlock = (int) Math.ceil(totPage / (double) PAGE_SCALE);
	}
	...
	public String toString() {
		return "LantourPagingDto [category=" + category + ", keyword=" + keyword + ", curPage=" + curPage
