...
SELECT * from RESERVATION
		...
		SELECT R.HOTEL_NO FROM RESERVATION AS R, HOTEL AS H
		WHERE TO_DATE(RESERVATION_DATE, 'YYYY-MM-DD') >=TO_DATE(#{check_in},'YYYY-MM-DD')
		AND TO_DATE(RESERVATION_DATE, 'YYYY-MM-DD') <![CDATA[ < ]]> TO_DATE(#{check_out},'YYYY-MM-DD')
		...
		SELECT R1.HOTEL_NO FROM RESERVATION R1, HOTEL H2
		AND R1.HOTEL_NO == H2.HOTEL_NO
		
	SELECT R.HOTEL_NO FROM RESERVATION R, HOTEL H		
	WHERE TO_DATE(R.RESERVATION_DATE, 'YYYY-MM-DD') >=TO_DATE('2021-07-01','YYYY-MM-DD')
		AND TO_DATE(R.RESERVATION_DATE , 'YYYY-MM-DD') < TO_DATE('9999-12-31','YYYY-MM-DD')
		AND R.HOTEL_NO IS NOT NULL
		AND R.HOTEL_NO = H.HOTEL_NO
	GROUP BY R.HOTEL_NO
	ORDER BY R.HOTEL_NO