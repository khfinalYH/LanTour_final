...
<body>
	...
	<div class="container">
		<div class="row flex-center mb-5">
			...
			<div>
				<ul class="pagination">
					<li class="page-item"><c:if test="${dto.nowBlock > 1}">
					...
					<c:forEach begin="${dto.blockBegin}" end="${dto.blockEnd}" var="index">
						<c:choose>
							...
							<c:otherwise>
								<li class="page-item"><a class="page-link" href="noticeList_category.do?nowPage=${index}&category=${dto.category}&keyword=${dto.keyword}">${index}</a></li>
							</c:otherwise>
						</c:choose>
					</c:forEach>
					...
					<c:if test="${dto.nowBlock < dto.totalBlock}">
						<li class="page-item"><a class="page-link" href="noticeList_category.do?nowPage=${dto.blockEnd+1}&category=${dto.category}&keyword=${dto.keyword}">&raquo;</a></li>
					</c:if>
				</ul>
			</div>
		</div>
