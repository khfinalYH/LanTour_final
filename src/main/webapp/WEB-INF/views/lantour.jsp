			...
			<c:choose>
				...
				<c:otherwise>
					...
					<c:forEach items="${list }" var="dto">
						<div class="card mb-3" style="width: 30%; float: left; min-height: 400px; margin-right: 20px; border: 1px solid #3984C0;"
						onclick="location.href='./lantourdetail.do?lantour_no=${dto.lantour_no } '">
							...
							<div class="card-footer text-muted">${dto.lantour_date }
							</div>
						</div>
					</c:forEach>
				</c:otherwise>
